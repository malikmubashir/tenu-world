...
2. **Médiateur de la consommation — PENDING (2026-04-17).** Shortlist evaluation in progress across MEDICYS, SMCE and AME Conso (annual fee, SaaS coverage, response-time SLA, consumer-facing visibility). Do not sign any of them in the interim. Must be resolved before commercial launch, not before beta.
